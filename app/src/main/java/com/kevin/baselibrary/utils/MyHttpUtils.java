...
//
//    public
//    static void asyncGet(String url, Map<String, Object> pairs, HttpCallback callBack) {
//        println "h2asyncGet:url=$url;pairs=$pairs"
//        String queryString = "";
//        pairs.each {
//            _m ->
//                    queryString += _m.key + "=" + _m.value.toString() + "&"
//        }
//        println "h2asyncGet:queryString=$queryString"
//        OkHttpClient client = new OkHttpClient();
//        Request request = new Request.Builder()
//                .url("$url?$queryString")
//                .build();
...
//                    callBack.onSucess(response_.body().string());
//                }
//            });
//        } catch (IOException e) {
//            println "h2asyncGet:error=" + e.getMessage()
//            e.printStackTrace();
//        }
//    }
//
...
//
//    public
//    static asyncPost(final String url, final Map<String, Object> pairs, final HttpCallback callBack) {
//        println "h2asyncPost:url=$url;pairs=$pairs"
//        OkHttpClient client = new OkHttpClient();
//        FormEncodingBuilder formEncodingBuilder = new FormEncodingBuilder();
//        pairs.each {
//            _m ->
//                    formEncodingBuilder.add(_m.key, _m.value.toString());
//            println "h2asyncPost:" + _m.key + "=" + _m.value.toString()
//        }
//        RequestBody formBody = formEncodingBuilder.build();
//        Request request = new Request.Builder()
//                .url(url)
...
//                FormEncodingBuilder formEncodingBuilder = new FormEncodingBuilder();
//
//                Iterator<Map.Entry<String, Object>> iterator = pairs.entrySet().iterator();
